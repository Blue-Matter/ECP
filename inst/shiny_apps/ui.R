...
sidebar <- dashboardSidebar(
  ...
  sidebarMenu(id='sidebar',
    menuItem("Selections", tabName = "home", icon = icon("house")),
    menuItem("Data Vizualization", tabName = "load", icon = icon("upload")),
    menuItem("ECP Properties", tabName = "fpi", icon = icon("chart-bar"))
  )
)
